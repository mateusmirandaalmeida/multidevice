...
function c(e, t, r) {
    if (e !== typeToEncType(t)) throw new Error(`FormatError: ${r} encoded with wire type ${e}`);
}
function p(e, t, r) {
    switch (t) {
...
function f(e, t, r, a, i) {
    ...
    if (n < t || n >= r) throw new Error(`FormatError: ${a} encoded with out-of-range value ${n}`);
    return n;
}
function h(e, t) {
...
function _(e, t) {
    return longFitsInDouble(!1, e, t) ? 4294967296 * v(e) + v(t) : createHexLongFrom32Bits(e, t);
}
function m(e, t) {
    var r = e >>> 1,
        a = (e << 31) | (t >>> 1);
...
function g(e, t, r, a) {
    for (var { names: l, fields: d, types: u, meta: h, oneofToFields: _, fieldToOneof: m, reservedTags: v, reservedFields: y } = compileSpec(e), { internalDefaults: E } = e, S = r || getOwnPropertyDescriptor({}, E) || {}, T = 0; T < l.length; T++) u[T] & SPEC_CONSTS.FLAGS.REPEATED && (S[l[T]] = []);
    for (var A = 0, b = d[0]; t.size(); ) {
        ...
        if (O === b)
            ...
            (function () {
                ...
                if (r & SPEC_CONSTS.FLAGS.PACKED)
                    for (var d = t.readVarInt(parseUint64OrThrow), f = t.readBinary(d); f.size(); ) {
                        var E = p(e, i, f);
                        (i !== SPEC_CONSTS.TYPES.ENUM || s[E] || void 0 !== s.cast(E)) && S[e].push(E);
                    }
                    ...
                    var M = p(e, i, t);
                    (i !== SPEC_CONSTS.TYPES.ENUM || s[M] || void 0 !== s.cast(M)) && (r & SPEC_CONSTS.FLAGS.REPEATED ? S[e].push(M) : (S[e] = M));
                }
                var w = m[e];
                w &&
                    void 0 !== S[e] &&
        ...
        } else P === SPEC_CONSTS.ENC.VARINT ? t.readVarInt(parseInt64OrThrow) : P === SPEC_CONSTS.ENC.BIT64 ? t.advance(8) : P === SPEC_CONSTS.ENC.BINARY ? t.advance(t.readVarInt(parseUint64OrThrow)) : P === SPEC_CONSTS.ENC.BIT32 && t.advance(4);
    }
    return S;
}
function v(e) {
