import { hexAt, hexLongIsNegative, hexLongToHex, negateHexLong, NUM_HEX_IN_LONG } from "../utils/HexHelper";
...
export class Binary {
  ...
  private readEndIndex: number;
  private writeIndex: number;
  private bytesTrashed: number = 0;
  private earliestIndex: number = 0;
  private readIndex: number = 0;
  private view: DataView = null;
  private littleEndian: boolean;
  private hiddenReads: number = 0;
  private hiddenWrites: number = 0;
  ...
  public peek(e: any, t: any = undefined) {
    this.hiddenReads++;
  ...
  public readWithViewParser(e, t, r, a) {
    return t(this.getView(), this.shiftReadOrThrow(e), e, r, a);
  }

  public readWithBytesParser(e, t, r, a) {
  ...
  public writeWithVarIntLength(e: any, t: any) {
    var r = this.writeIndex,
  ...
  private shiftWriteMaybeReallocate(e: any) {
