(e,t)=>{
    ...
    ,
    t.encodeB64UrlSafe = function(e, t=!1) {
        return a(e, 45, 95, t)
    }
    ,
    t.decodeB64 = function(e) {
        var t = n(e, 43, 47, 61);
        if (t)
            return t.buffer;
    ...
    ,
    t.BASE64_DATA_URL_SCHEME = void 0;
    var r = 3e3;
    function a(e, t, a, n) {
        ...
        for (var i = e.length, n = new Int32Array(i + i % 4), s = 0; s < i; s++) {
            ...
            if (65 <= o && o <= 90)
                ...
                if (o !== r) {
                    ...
                    return null != self.ERROR && __LOG__(4, void 0, new Error)`Found unexpected character code while decoding B64 at index ${s}, length ${i}: ${o}`,
                    null
                }
                n[s] = 63
            }
